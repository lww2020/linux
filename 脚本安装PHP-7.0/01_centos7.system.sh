...
#6、修改history大小
#sed -n '/HISTSIZE=1000/p' /etc/profile
...
# 8、推荐安装依赖关系
yum -y install gcc gcc-c++ make autoconf wget lrzsz libjpeg libjpeg-devel libpng libpng-devel icu libicu libicu-devel
...
yum -y install redhat-lsb epel-release libmemcached libmemcached-devel db4-devel libXpm-devel tree  libtool-ltdl-devel
